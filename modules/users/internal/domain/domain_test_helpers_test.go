...
func assertDomainEventPublished[T events.DomainEvent](t *testing.T, src domainEventSource) T {
	t.Helper()
...
func assertNoDomainEventPublished[T events.DomainEvent](t *testing.T, src domainEventSource) {
	t.Helper()
