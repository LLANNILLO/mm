...
func (h *Handler) createEvent(w http.ResponseWriter, r *http.Request) {
	...
	id, err := h.deps.CreateEvent.Handle(r.Context(), createevent.Command{
...
func (h *Handler) getEvent(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.deps.GetEvent.Handle(r.Context(), getevent.Query{ID: id})
	if err != nil {
		handleDomainError(w, err)
		return
	}
...
func (h *Handler) listEvents(w http.ResponseWriter, r *http.Request) {
	items, err := h.deps.ListEvents.Handle(r.Context())
	if err != nil {
		handleDomainError(w, err)
		return
	}
...
func (h *Handler) searchEvents(w http.ResponseWriter, r *http.Request) {
	...
	page, err := h.deps.SearchEvents.Handle(r.Context(), query)
	if err != nil {
		handleDomainError(w, err)
		return
	}
...
func (h *Handler) publishEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.deps.PublishEvent.Handle(r.Context(), publishevent.Command{EventID: id}); err != nil {
		handleDomainError(w, err)
		return
	}
...
func (h *Handler) cancelEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.deps.CancelEvent.Handle(r.Context(), cancelevent.Command{EventID: id}); err != nil {
		handleDomainError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
...
func (h *Handler) rescheduleEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.deps.RescheduleEvent.Handle(r.Context(), rescheduleevent.Command{
		EventID:     id,
		StartsAtUtc: req.StartsAtUtc,
		EndsAtUtc:   req.EndsAtUtc,
	}); err != nil {
