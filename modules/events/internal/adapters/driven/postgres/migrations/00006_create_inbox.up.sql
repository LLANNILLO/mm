...
CREATE TABLE IF NOT EXISTS events.inbox_message_consumers (
    message_id UUID          NOT NULL,
    name       VARCHAR(500)  NOT NULL,
    CONSTRAINT pk_events_inbox_message_consumers PRIMARY KEY (message_id, name)
);
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS events.inbox_message_consumers;
-- +goose StatementEnd
